...
public class TimePickerView extends ConstraintLayout implements TimePickerControls {
                ...
                new GestureDetector(
                        ...
                        new SimpleOnGestureListener() {
                            ...
                            public boolean onDoubleTap(MotionEvent e) {
                                final TimePickerView.OnDoubleTapListener listener = onDoubleTapListener;
                                if (listener != null) {
    ...
    void setOnPeriodChangeListener(TimePickerView.OnPeriodChangeListener onPeriodChangeListener) {
    ...
    void setOnDoubleTapListener(@Nullable TimePickerView.OnDoubleTapListener listener) {
