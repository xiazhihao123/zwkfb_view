...
public class ClockHandView extends View {
    ...
    private final List<ClockHandView.OnRotateListener> listeners = new ArrayList<>();
    ...
    private void setHandRotationInternal(
        ...
        for (ClockHandView.OnRotateListener listener : listeners) {
    ...
    public void addOnRotateListener(ClockHandView.OnRotateListener listener) {
        listeners.add(listener);
    }

    public void setOnActionUpListener(ClockHandView.OnActionUpListener listener) {
