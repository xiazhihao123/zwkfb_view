 ...
 * 版本：0.1.6
 */
fun AlertDialog.置图标(资源Id: Int) = this.setIcon(资源Id)
 ...
 * 版本：0.1.6
 */
fun AlertDialog.置图标属性(属性Id: Int) = this.setIconAttribute(属性Id)
 ...
 * 版本：0.1.6
 */
fun Builder.置确定按钮图标(图标: Drawable) : Builder =
 ...
 * 版本：0.1.6
 */
fun Builder.置取消按钮图标(图标: Drawable) : Builder =
 ...
 * 版本：0.1.6
 */
fun Builder.置忽略按钮图标(图标: Drawable) : Builder =
 ...
 * 版本：0.1.6
 */
fun Builder.置视图(布局资源Id: Int) : Builder = this.setView(布局资源Id)
 ...
 * 版本：0.1.6
 */
fun Builder.置视图(视图: View) : Builder = this.setView(视图)
...
fun Builder.置回收测量启用(启用: Boolean) : Builder =
